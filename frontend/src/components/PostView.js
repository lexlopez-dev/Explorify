...
const PostView = (props) => {
    ...
    const attachmentImageVisible = post.attachment && post.attachment.fileType.startsWith('image');
        ...
        <div className="card-group">
            ...
            {ownedByLoggedInUser && (
                <div className="dropdown">
                    <span 
                        className="btn btn-sm btn-light dropdown-toggle" data-testid="post-actions" 
                        ref={actionArea} 
                    />
                    <div 
                        className={dropDownClass} data-testid="post-action-dropdown"
                    >
                        <button 
            ...
            {attachmentImageVisible && (
                <div className="pl-5">
                    <img alt="attachment" src={`/images/attachments/${post.attachment.name}`} className="img-fluid"
